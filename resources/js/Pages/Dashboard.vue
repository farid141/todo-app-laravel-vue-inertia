  ...
  <AuthenticatedLayout>
    ...
    <div class="py-12">
      <div class="mx-auto max-w-full sm:px-6 lg:px-8 grid grid-cols-7 gap-4">
        <div
          class="col-span-5 overflow-hidden bg-white shadow-sm sm:rounded-lg"
        >
            ...
            <table id="myTable" class="">
              ...
              <tbody>
                <tr v-for="(task, index) in tasks" :key="task.id">
                  ...
                  <td>
                    <span
                      v-for="(tag, tagIdx) in task.tagList"
                      :key="tagIdx"
        ...
        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900">
            ...
            <ul class="space-y-2">
              <li
                v-for="(count, index) in tag_by_task"
                v-bind:key="index"
        ...
        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900">
            ...
            <ul class="space-y-2">
              <li
                v-for="(count, index) in tag_by_subtask"
                :key="index"
                class="flex items-center"
              >
                <span class="text-gray-700 mr-2">{{ index + 1 }}</span>
        ...
        <div
          class="overflow-hidden bg-white shadow-sm sm:rounded-lg col-span-6"
        >
          <div class="border rounded-lg mt-3">
            ...
            <!-- Subtask List -->
            <div
              v-for="(user, index) in subtask_by_user"
              :key="index"
            ...
            >
              ...
              <div class="col-span-8">
                ...
                <p
                  v-for="(subtask, subtaskId) in user.subtasks"
                  :key="subtaskId"
                >
                  {{ subtask.title }}
                </p>
